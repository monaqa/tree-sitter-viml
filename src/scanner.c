...
keyword keywords[] = {
  ...
  KEYWORD(UNMAP, "unm", "ap", true),
  KEYWORD(NUNMAP, "nun", "map", true),
  KEYWORD(VUNMAP, "vu", "nmap", true),
  KEYWORD(XUNMAP, "xu", "nmap", true),
  KEYWORD(SUNMAP, "sunm", "ap", true),
  KEYWORD(OUNMAP, "ou", "nmap", true),
  KEYWORD(IUNMAP, "iu", "nmap", true),
  KEYWORD(LUNMAP, "lu", "nmap", true),
  KEYWORD(CUNMAP, "cu", "nmap", true),
  KEYWORD(TUNMAP, "tunma", "p", true),
